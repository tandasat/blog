...
This post focuses on SMI deprivileging. For security policy reporting and interaction with Windows, stay tuned for the next post.
...
This section explains how IO port and MSR access ISRD policies are installed, and then, updated by OEM. The overview is depicted below.
